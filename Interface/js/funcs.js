...
//FUNÇÃO PARA DIVIDIR E APLICAR JUROS NO PAGAMENTO
function ParcelamentoNovaInterface(tipo, valor, codnota, juros, juros2, entrada, novadata, novoparam, tipopagentrada) {
    ...
    // Arquivo PHP juntamente com o valor digitado no campo (método GET)
    var url = "Action/validacao.php?codnota=" + codnota + "&valor=" + valor + "&tipo=" + tipo + "&juros=" + juros + "&juros2=" + juros2 + "&entrada=" + entrada + "&novadata=" + novadata + "&novoparam=" + novoparam + "&tipopagentrada=" + tipopagentrada;
    ...
    req.onreadystatechange = function () {
        ...
        // Exibe a mensagem "Buscando Noticias..." enquanto carrega
        if (req.readyState == 1) {
            document.getElementById('resultadodoparcelamentoTipo').innerHTML = 'Carregando...';
        }
        ...
        if (req.readyState == 4 && req.status == 200) {
            ...
            // Abaixo colocamos a(s) resposta(s) na div resultado
            document.getElementById('resultadodoparcelamentoTipo').innerHTML = resposta;
...
//FUNÇÃO PARA DIVIDIR E APLICAR JUROS NO PAGAMENTO
function ParcelamentoNovaInterface2(tipo, valor, codnota, juros, juros2, entrada, novadata, novoparam, tipopagentrada) {
    ...
    req.onreadystatechange = function () {
        ...
        // Exibe a mensagem "Buscando Noticias..." enquanto carrega
        if (req.readyState == 1) {
            document.getElementById('resultadodoparcelamento2').innerHTML = 'Carregando...';
        }
        ...
        if (req.readyState == 4 && req.status == 200) {
            ...
            // Abaixo colocamos a(s) resposta(s) na div resultado
            document.getElementById('resultadodoparcelamento2').innerHTML = resposta;
...
//FUNCAO JAVASCRIP PARA PESQUISAR PRODUTOS E GERAR PAGINAS DE CONTROLE DE DADOS 
function PagPesquisarLojas(tipo, param, valor) {
    ...
    req.onreadystatechange = function () {
        ...
        // Exibe a mensagem "Aguarde..." enquanto carrega
        if (req.readyState == 1) {
            document.getElementById('ResultadoPesquisaLoja').innerHTML = 'Aguarde...';
        }
        ...
        if (req.readyState == 4 && req.status == 200) {
            ...
            // Abaixo colocamos a resposta na div conteudo
            document.getElementById('ResultadoPesquisaLoja').innerHTML = resposta;
...
function PagVerTudoTipoCrediario(tipo, codnota, tipopesquisa, id) {
    ...
    // Arquivo PHP juntamento com a id da noticia (método GET)
    var url = "Action/validacao.php?tipo=" + tipo + "&codnota=" + codnota + "&tipopesquisa=" + tipopesquisa + "&id=" + id;
...
//PAGINA VALIDACAO PARA PAGAR PARCELA
function validacaopagarparcela(tipo, param, valor, id) {
...
function validacaopagarparcela2(tipo, param, valorpag, tipopag, valor, id) {
    ...
    // Arquivo PHP juntamente com o valor digitado no campo (método GET)
    var url = "Action/validacao.php?tipo=" + tipo + "&param=" + param + "&valorpag=" + valorpag + "&tipopag=" + tipopag + "&valor=" + valor + "&id=" + id;
    // Chamada do método open para processar a requisição
    req.open("Get", url, true);
