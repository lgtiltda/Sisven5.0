...
?>      
                ...
                <table class="table table-borderless" style="margin-top:-20px; border: none;   width: 100%;">  
                    ...
                    <td colspan="" style="width: 30%; text-align: right; font-size: 14pt; ">
                        <h4>Faturamento Mensal -<?= mostraMes($_GET['mes']) ?>/<?= $_GET['ano']; ?> </h4>
...
<table class="table table-bordered" style="width: 100%;">  
    ...
    for ($i = 1; $i <= 31; $i++) {
        ...
        $listaNotasDia2 = $notasController->RetornarNotasDiaMesAnoF(2, 1, $i, $mes_hoje, $ano_hoje);
    ...
    if ($listaUsuariosBusca2 != null) {
        foreach ($listaUsuariosBusca2 as $usu) {
            ...
            <tr>
                ...
                $totalusu = 0;
                $filtro = $usu->getCod();
                $listaNotas = $notasController->RetornarNotasDiaMesAno(5, $filtro, $dia_hoje, $mes_hoje, $ano_hoje);
